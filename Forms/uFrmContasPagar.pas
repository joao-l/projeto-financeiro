...
begin
  ...
  if DS.DataSet.FieldByName('VALORPAGO').IsNull then
    ...
    ShowMessage('Não é possível apagar um título já pago!');
...
begin
  inherited;
  // Caso o usuário deseje apagar os campos de pesquisa:
  LimparPesquisas(DS);
...
begin
  inherited;
  // Bloqueio p/ que o usuario digite apenas números no campo de 'Número do Título'
