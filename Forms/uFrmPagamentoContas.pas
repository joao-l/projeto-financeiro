...
begin
  ...
  // Validação p/ que o usuario não consiga dar baixar em um título
  // já pago
  if DS.DataSet.FieldByName('VALORPAGO').IsNull then
    inherited
  else
    ShowMessage('Título já possui baixa!');
end;
...
begin
  // Antes de Realizar o Post é feito o calculo de Juros:
  ...
  begin
    ...
    begin
      // Calculo do Juros é feito, e o DataSet recebe o valor do Juros atualizado
...
begin
  inherited;
  // Atualizando o Título do botão, p/ que o usuario saiba
  // a que título ele se refere (Pagamento Ou Recebimento)
